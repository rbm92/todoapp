<template>
  <!-- Adding a new task -->
  <form class="mx-auto my-20 p-5 rounded-md bg-gray-100 shadow-lg w-11/12 sm:w-3/4 justify-center flex flex-col items-center gap-y-5 dark:bg-gray-400" action="">
